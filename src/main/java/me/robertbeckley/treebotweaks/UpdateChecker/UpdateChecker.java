package me.robertbeckley.treebotweaks.UpdateChecker;
...
public class UpdateChecker {
    ...
    public String requiredPermission = "treebotweaks.admin.updatechecker";
    ...
    public UpdateChecker(TreeboTweaks main) {
        this.pl = main;
    }
